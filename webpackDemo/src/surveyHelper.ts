...
export class SurveyHelper {
    ...
    public static getNewQuestionTypeName(questionType:any,objs: Array<any>) {
        if(questionType==="hr"){
            return SurveyHelper.getNewName(objs, editorLocalization.getString("ed.newQuerstionHrName"));
        }else{
    ...
    public static getNewName(objs: Array<any>, baseName: string): string {
        ...
        // var nums = SurveyHelper.numToC(num);
