...
export class SurveyObjectProperty {
    ...
    public koText: any;
    public koScore:any;
    public koIsScore:boolean;
    public koIsTk:boolean;
    public kotkText:string;
    ...
    constructor(public property: Survey.JsonObjectProperty, onPropertyChanged: SurveyOnPropertyChangedCallback = null, propertyEditorOptions: any = null) {
        ...
        this.cnName = editorLocalization.getString("cn."+this.property.name);
        this.koValue = ko.observable();
        this.choices = property.choices;
        var self = this;
        this.editorType = property.type;
        //TODO
        if(this.name=="referKey"){
            this.choices=EditorUrl.refer_Key;
        }
